...
<html>
 ...
 <body>
  ...
  <div class="container">
    <h2>For Students</h2>
    <h4>Go-> <a href="student.php">Student Dashboard</a></h4>
    <hr>
    <h2>For Faculty</h2>
    ...
    <br>
     ...
     <!-- FOOTER -->
      <footer style="background:; height:120%;">
        ...
        <p>&copy;  developed by  <a href="https://pramod-paratabadi.github.io/Resume_Pramod_P/">Pramod Paratabadi </a><a href="http://projectworlds.in"></p>
      </footer>
